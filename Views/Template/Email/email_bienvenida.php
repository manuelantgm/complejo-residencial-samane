		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido a <strong><?= NOMBRE_EMPRESA ?></strong>.</p>
					<p>¡Gracias por confiar en nosotros y unirte a la familia <?= NOMBRE_EMPRESA ?>! Estamos emocionados de ser parte de tu éxito y de proporcionarte las herramientas que necesita tu negocio para alcanzar nuevas alturas.</p>
					...
					<a href="<?= BASE_URL; ?>" target="_blank" class="x_button_link x_link_blue">Entrar ahora</a>
